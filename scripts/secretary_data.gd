...
## 段階的チュートリアル（最初の7ヶ月はガイド付き強制フロー）
## 月0: PM採用 → 月1: プロダクト作成 → 月2: 受託開発 → 月3: エンジニア採用
## → 月4: 開発 → 月5: チームケア → 月6: 自由
const TUTORIAL_STEPS := [
	...
	},
	{
		"id": "month_1",
		"trigger": "month_1",
		"forced_action": "create_product",
		"messages": [
			"PMを採用できましたね！素晴らしい第一歩です。",
			"次はプロダクトを作りましょう。「プロダクトを作る」ボタンを押してください。",
			"SaaSプロダクトなら初期費用200万円で始められます。",
		],
	},
	{
		"id": "month_2",
		"trigger": "month_2",
		"forced_action": "contract_work",
		"messages": [
			"プロダクトの土台ができました！",
			"ところで…資金がだいぶ減ってきていますね。",
			"スタートアップ経営で最も大事なのは「お金が尽きないこと」です。",
			"「受託開発」で他社の案件を受けてお金を稼ぎましょう。",
			"受託中はプロダクト開発が止まりますが、確実に収入が得られます。",
			"エンジニアの技術力も上がるので、序盤にはオススメの戦略です。",
		],
	},
	{
		"id": "month_3",
		...
		"forced_action": "hire",
		"messages": [
			"受託開発で資金を確保できました！エンジニアのスキルも上がりましたね。",
			"次はエンジニアを採用して開発を加速しましょう。",
	...
	},
	{
		...
		"messages": [
			...
			"ここからは自由に経営できます。マーケティングや受託開発も使えます。",
			"資金が尽きそうになったら資金調達や受託開発を検討してくださいね。",
